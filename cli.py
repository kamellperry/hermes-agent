...
class HermesCLI(CLIAgentSetupMixin, CLICommandsMixin, CLIBillingMixin):
    ...
    def __init__(
        ...
        # shared chokepoint in hermes_constants (Closes #21256). The env var
        # remains a one-shot override for subprocess orchestrators such as the
        # optional update conflict resolver.
        from hermes_constants import resolve_reasoning_config
        _env_reasoning_effort = os.getenv("HERMES_REASONING_EFFORT", "")
        self.reasoning_config = (
            _parse_reasoning_config(_env_reasoning_effort)
